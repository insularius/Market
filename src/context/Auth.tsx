...
export const AuthProvider: React.FC<PropsWithChildren<{}>> = ({ children }) => {
  ...
  // const sendEmailVerificationPassword = (email: string, password: string) => {
  //   const url = BASE_GRIFFON_URL + GRIFFON_USER_EMAIL;
  ...
  // const sendEmailVerificationCode = (email: string, password: string) => {
  //   const url = BASE_GRIFFON_URL + GRIFFON_EMAIL_VERIFY_CODE;
